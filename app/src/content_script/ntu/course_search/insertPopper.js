function insertPopper(){
  ...
  popper.style = "position: absolute;background: #F5F5F5;color: black;width: 600px;height: 300px;border-radius: 20px;box-shadow: 0 0 2px rgba(0,0,0,0.5);padding: 10px;text-align: center;";
