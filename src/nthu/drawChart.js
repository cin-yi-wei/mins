...
if (location.pathname == "/ccxp/COURSE/JH/common/Syllabus/*" ||
    location.pathname == "/ccxp/INQUIRE/JH/common/Syllabus/*" ||
    location.pathname == "/ccxp/INQUIRE/JH/8/8.3/8.3.3/JH83302.php*") {
      
    console.log("drawchat",location.pathname);
